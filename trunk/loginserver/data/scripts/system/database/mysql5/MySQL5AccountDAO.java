...
public class MySQL5AccountDAO extends AccountDAO {
	...
	public boolean insertAccount(Account account) {
		int result = 0;
		PreparedStatement st = DB.prepareStatement("INSERT INTO account_data(`name`, `password`, access_level, membership, activated, last_server, last_ip, last_mac, ip_force, expire) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
