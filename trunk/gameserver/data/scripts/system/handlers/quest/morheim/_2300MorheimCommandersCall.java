...
public class _2300MorheimCommandersCall extends QuestHandler {
	...
	public void register() {
		...
		qe.registerOnEnterZone(ZoneName.MORHEIM_ICE_FORTRESS_220020000, questId);
	}
	...
	public boolean onEnterZoneEvent(QuestEnv env, ZoneName zoneName) {
		return defaultOnEnterZoneEvent(env, zoneName, ZoneName.MORHEIM_ICE_FORTRESS_220020000);
	}
}
