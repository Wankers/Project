...
import gameserver.model.instance.instancereward.TvtReward;
...
import gameserver.services.tvt.TvtBossTemplate;
...
//import gameserver.utils.i18n.CustomMessageIdRU;
...
public class TvTInstance extends GeneralInstanceHandler {
    ...
    {
        for (gameserver.skillengine.model.Effect ef : player.getEffectController().getAbnormalEffects()) {
				if (ef.isAvatar()) {
					ef.endEffect();
