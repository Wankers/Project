...
public class AbyssalSplinterInstance extends GeneralInstanceHandler {
	...
	private void spawnPortalDevice(){
	  spawn(281905, 303.69f,  736.35f,  197.7f, (byte) 0);
		spawn(282038, 335.19f, 708.92f, 197.9f, (byte) 0);
		spawn(282039, 360.23f, 741.07f, 197.7f, (byte) 0 );
 }
	...
	private void abyssalBlessing() {
		for (Player p : instance.getPlayersInside()) {
			 SkillTemplate st =  DataManager.SKILL_DATA.getSkillTemplate(19283);		
				Effect e = new Effect(p, p, st, 1,  st.getEffectsDuration());
				e.initialize();
				e.applyEffect();
