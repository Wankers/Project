...
public class KysisInstance extends GeneralInstanceHandler {
	...
	public void onLeaveInstance(Player player) {
		...
		bag.decreaseByItemId(185000061, bag.getItemCountByItemId(185000061));
		bag.decreaseByItemId(185000062, bag.getItemCountByItemId(185000062));
		bag.decreaseByItemId(185000063, bag.getItemCountByItemId(185000063));
		bag.decreaseByItemId(185000064, bag.getItemCountByItemId(185000064));
		bag.decreaseByItemId(185000065, bag.getItemCountByItemId(185000065));
	}
}
