...
public class MySQL5PlayerEmotionListDAO extends PlayerEmotionListDAO {
	 ...
	 * (non-Javadoc)
	 * @see
	 * gameserver.dao.PlayerEmotionListDAO#loadEmotions(gameserver.model.gameobjects.player.Player
	 * )
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * gameserver.dao.PlayerEmotionListDAO#insertEmotion(gameserver.model.gameobjects.player.Player
	 * , int)
	 */
	@Override
