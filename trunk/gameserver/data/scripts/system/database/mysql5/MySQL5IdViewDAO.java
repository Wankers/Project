...
public class MySQL5IdViewDAO extends IdViewDAO
{
	...
	public static final String SELECT_QUERY = "SELECT `players`.`id` AS `id` from `players` UNION SELECT `item_unique_id` FROM `inventory` UNION SELECT `id` FROM `legions` UNION SELECT `mail_unique_id` FROM `mail`";
