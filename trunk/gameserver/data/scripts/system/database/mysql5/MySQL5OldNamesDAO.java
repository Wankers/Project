...
public class MySQL5OldNamesDAO extends OldNamesDAO {
	...
	private static final String DELETE_NAMES_QUERY = "DELETE FROM old_names WHERE player_id = ?";
	...
	public void deleteNames(int Id) {
		PreparedStatement statement = DB.prepareStatement(DELETE_NAMES_QUERY);
		try {
