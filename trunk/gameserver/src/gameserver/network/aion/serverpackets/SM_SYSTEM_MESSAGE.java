...
public class SM_SYSTEM_MESSAGE extends AionServerPacket {
	...
	*/
	public static final SM_SYSTEM_MESSAGE STR_SKILL_SUCC_Slow_END_ME_TO_SELF = new SM_SYSTEM_MESSAGE(1200323);
        /**
         * Assembly Item Success
         */
        public static final SM_SYSTEM_MESSAGE ASSEMBLY_ITEM_SUCCEEDED = new SM_SYSTEM_MESSAGE(1401122);
        /**
         * Assembly Item Cancelled
         */
        public static final SM_SYSTEM_MESSAGE ASSEMBLY_ITEM_CANCELED = new SM_SYSTEM_MESSAGE(1401123);
        /**
         * Assembly Items Part Not Enough
         */
        public static final SM_SYSTEM_MESSAGE ASSEMBLY_ITEM_NOT_ENOUGH = new SM_SYSTEM_MESSAGE(1401124);
...
/ChannelHelp: Shows the commands available for channels.
	...
	* %1 of %0 uses %3 in %2.
	*/
	public static SM_SYSTEM_MESSAGE STR_SKILL_ABYSS_SKILL_IS_FIRED(Player player, DescriptionId skillNameId) {
		return new SM_SYSTEM_MESSAGE(1390155, player.getRace().getRaceDescriptionId(), player.getName(), 
			"%SubZone:" + player.getPosition().getMapId() + " " + player.getPosition().getX() + " " + player.getPosition().getY() + " " + player.getPosition().getZ(), skillNameId);
	}
	...
	* %0 has been sealed.
	*/
	public static SM_SYSTEM_MESSAGE STR_MSG_ITEM_SEAL_START_DONE(DescriptionId descriptionId) {
		return new SM_SYSTEM_MESSAGE(1400797, descriptionId);
	}

	/**
	* Canceled sealing %0.
	*/
	public static SM_SYSTEM_MESSAGE STR_MSG_ITEM_SEAL_START_CANCEL(DescriptionId descriptionId) {
		return new SM_SYSTEM_MESSAGE(1400798, descriptionId);
	}
