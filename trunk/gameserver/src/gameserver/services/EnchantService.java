...
import gameserver.model.stats.calc.functions.StatEnchantFunction;
import gameserver.model.stats.container.StatEnum;
import gameserver.model.stats.listeners.ItemEquipmentListener;
...
public class EnchantService {
	...
	public static boolean enchantItem(Player player, Item parentItem, Item targetItem, Item supplementItem) {
		...
		if (supplementItem != null) {
			...
			if (!player.getInventory().decreaseByItemId(supplementId, supplementUseCount))
				return false;
