...
public class PunishmentService {
	...
	public static void unbanChar(int playerId) {
		...
		MessagerAddition.global("Player Object Id" + playerId + "was unbanned");
	}
	...
	public static void banChar(int playerId, int dayCount, String reason) {
		...
		MessagerAddition.global("Player Object Id " + playerId + " was Banned upon "+ dayCount + " days.\nBy Reason: "+ reason);
	}
	...
	public static void setIsInPrison(Player player, boolean state, long delayInMinutes, String reason) {
		...
		if (state) {
            ...
            MessagerAddition.global("Character "+ player.getName() + " was teleported to prison, upon " + delayInMinutes +" min.\nBy Reason: "+ reason);
