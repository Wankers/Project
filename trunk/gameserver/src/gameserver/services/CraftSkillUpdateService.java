...
public class CraftSkillUpdateService {
	...
	private CraftSkillUpdateService() {
		...
		npcBySkill.put(830148, new LearnTemplate(30002, false, "Extract Vitality"));
		npcBySkill.put(204257, new LearnTemplate(30003, false, "Extract Aether"));
		npcBySkill.put(830150, new LearnTemplate(30003, false, "Extract Aether"));

		npcBySkill.put(204100, new LearnTemplate(40001, true, "Cooking"));
		npcBySkill.put(830142, new LearnTemplate(40001, true, "Cooking"));
		npcBySkill.put(204104, new LearnTemplate(40002, true, "Weaponsmithing"));
		npcBySkill.put(830146, new LearnTemplate(40002, true, "Weaponsmithing"));
		npcBySkill.put(204106, new LearnTemplate(40003, true, "Armorsmithing"));
		npcBySkill.put(830144, new LearnTemplate(40003, true, "Armorsmithing"));
		npcBySkill.put(204110, new LearnTemplate(40004, true, "Tailoring"));
		npcBySkill.put(830148, new LearnTemplate(40004, true, "Tailoring"));
		npcBySkill.put(204102, new LearnTemplate(40007, true, "Alchemy"));
		npcBySkill.put(830140, new LearnTemplate(40007, true, "Alchemy"));
		npcBySkill.put(204108, new LearnTemplate(40008, true, "Handicrafting"));
		npcBySkill.put(830150, new LearnTemplate(40008, true, "Handicrafting"));
		npcBySkill.put(798452, new LearnTemplate(40010, true, "Construction"));
		npcBySkill.put(798456, new LearnTemplate(40010, true, "Construction"));

		// Elyos
		npcBySkill.put(203780, new LearnTemplate(30002, false, "Extract Vitality"));
		npcBySkill.put(830064, new LearnTemplate(30002, false, "Extract Vitality"));
		npcBySkill.put(203782, new LearnTemplate(30003, false, "Extract Aether"));
		npcBySkill.put(830066, new LearnTemplate(30003, false, "Extract Aether"));

		npcBySkill.put(203784, new LearnTemplate(40001, true, "Cooking"));
		npcBySkill.put(830058, new LearnTemplate(40001, true, "Cooking"));
		npcBySkill.put(203788, new LearnTemplate(40002, true, "Weaponsmithing"));
		npcBySkill.put(830062, new LearnTemplate(40002, true, "Weaponsmithing"));
		npcBySkill.put(203790, new LearnTemplate(40003, true, "Armorsmithing"));
		npcBySkill.put(830060, new LearnTemplate(40003, true, "Armorsmithing"));
		npcBySkill.put(203793, new LearnTemplate(40004, true, "Tailoring"));
		npcBySkill.put(830052, new LearnTemplate(40004, true, "Tailoring"));
		npcBySkill.put(203786, new LearnTemplate(40007, true, "Alchemy"));
		npcBySkill.put(830054, new LearnTemplate(40007, true, "Alchemy"));
		npcBySkill.put(203792, new LearnTemplate(40008, true, "Handicrafting"));
		npcBySkill.put(830056, new LearnTemplate(40008, true, "Handicrafting"));
		npcBySkill.put(798454, new LearnTemplate(40010, true, "Construction"));
		npcBySkill.put(798450, new LearnTemplate(40010, true, "Construction"));
