...
import gameserver.model.templates.tradelist.TradeListTemplate;
...
import gameserver.network.aion.serverpackets.SM_TRADE_IN_LIST;
		...
		switch (dialogId) {
			...
			case 10001: {
				switch (npc.getNpcId()) {
					...
					case 730220:
					case 730221: {
						TeleportService.teleportTo(player, 600020000, 1367.4562f, 1464.4529f, 599.5012f, 3000, true);
						break;
					}
					default: {
						PacketSendUtility.sendPacket(player, new SM_DIALOG_WINDOW(targetObjectId, dialogId, questId));
			...
			case 10002: {
				switch (npc.getNpcId()) {
					case 730220: {
						TeleportService.teleportTo(player, 700010000, 1271.8334f, 1871.8433f, 97.706604f, 3000, true);
						break;
					}
					case 730221: {
						TeleportService.teleportTo(player, 710010000, 1043.7046f, 1516.1797f, 98.13078f, 3000, true);
						break;
					}
					default: {
						PacketSendUtility.sendPacket(player, new SM_DIALOG_WINDOW(targetObjectId, dialogId, questId));
