...
import gameserver.model.gameobjects.player.emotion.EmotionList;
import gameserver.model.gameobjects.player.motion.MotionList;
import gameserver.model.gameobjects.player.npcFaction.NpcFactions;
...
import gameserver.model.items.storage.LegionStorageProxy;
...
import gameserver.model.team2.alliance.PlayerAllianceGroup;
import gameserver.model.team2.common.legacy.LootGroupRules;
import gameserver.model.team2.group.PlayerGroup;
import gameserver.global.protection.AntiHackController;
import gameserver.model.templates.BoundRadius;
import gameserver.model.templates.flypath.FlyPathEntry;
import gameserver.model.templates.item.ItemAttackType;
import gameserver.model.templates.item.ItemTemplate;
import gameserver.model.templates.npc.AbyssNpcType;
...
public class Player extends Creature {
	...
	private gameserver.model.team2.group.PlayerGroup playerGroup2;
	...
	private MotionList motions;
        private AntiHackController antiHackController;
    ...
    /**
     * AntiSpam message delay by Khaos
     */
	...
	public Player(PlayerController controller, PlayerCommonData plCommonData, PlayerAppearance appereance, Account account) {
        ...
        this.antiHackController = new AntiHackController();
    ...
    public AntiHackController getAntiHackController() {
    	return this.antiHackController;
    }
    ...
    public String getWedding(){
    	return playerCommonData.getWedding();
    }

    public void setWedding(String wedding){
    	playerCommonData.setWedding(wedding);
    }
	...
	public gameserver.model.team2.group.PlayerGroup getPlayerGroup2() {
		return playerGroup2;
	}

	public void setPlayerGroup2(gameserver.model.team2.group.PlayerGroup playerGroup) {
	...
	public boolean isEnemyFrom(Player player) {
		return player.getObjectId() != getObjectId() && ((getAdminEnmity() > 1 || player.getAdminEnmity() > 1) 
				|| !player.getRace().equals(getRace()) || getController().isDueling(player)
				|| (this.isInsideZoneType(ZoneType.PVP) && player.isInsideZoneType(ZoneType.PVP) && !isInSameGroup(player)));
	}
	...
	public gameserver.model.team2.alliance.PlayerAlliance getPlayerAlliance2() {
	...
	public void setTelEffect(int id) {
		this.teleportEid = id;
	}
	
	public int getTelEffect() {
		return this.teleportEid;
	}
}