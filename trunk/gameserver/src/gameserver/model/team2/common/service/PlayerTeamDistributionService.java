 ...
 */
package gameserver.model.team2.common.service;
...
import gameserver.model.gameobjects.player.XPCape;
...
public class PlayerTeamDistributionService {
	...
	private static boolean hasOneLivingPlayer(PlayerGroup group) {
	...
	private static class PlayerGroupRewardStats implements Predicate<Player> {
