...
public abstract class LegionDAO implements IDFactoryAwareDAO {
     ...
     * @param legion 
     */
    public abstract void loadLegionWarehouseHistory(Legion legion);
    /**
     * 
     * @param legionId
     * @param legionHistory 
     */
    public abstract boolean saveNewLegionWarehouseHistory(int legionId, LegionHistory legionHistory);
    /**
     * 
     * @param legionId
     * @param key 
     */
    public abstract void removeOldLegionWarehouseHistory(int legionId, Timestamp key);

	public abstract long loadLegionKinah(Legion legion);

	public abstract void setLegionKinah(Legion legion, long legionKinah);

	public abstract boolean saveNewLegionKinah(Legion legion);
}
