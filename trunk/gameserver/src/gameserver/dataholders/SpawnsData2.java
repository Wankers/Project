...
import gameserver.model.templates.spawns.*;
import gameserver.model.templates.spawns.siegespawns.SiegeSpawn;
...
public class SpawnsData2 {
	...
	public synchronized boolean saveSpawn(Player admin, VisibleObject visibleObject, boolean delete) throws IOException {
		...
		if (delete && oldGroup.getSpawnSpotTemplates().isEmpty())
			map.removeSpawns(oldGroup);
		else if (addGroup)
