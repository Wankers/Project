...
import com.aionemu.chatserver.model.channel.LocalizationChannels;
...
/**
 * @author ATracer = Multilanguage Support Localization
 */
public class CM_CHANNEL_REQUEST extends AbstractClientPacket {
	...
	//	Channel channel = chatService.registerPlayerWithChannel(chatClient, channelIndex, channelIdentifier);
	    Channel channel = ChatService.getInstance().registerPlayerWithChannel(chatClient, channelIndex, LocalizationChannels.Translate(channelIdentifier));
		if (channel != null) {
