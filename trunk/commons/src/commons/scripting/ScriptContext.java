...
public interface ScriptContext {
	 ...
	 * After compilation static methods marked with {@link commons.scripting.metadata.OnClassLoad} are invoked
	 */
	public void init();

	/**
	 * Notifies all script classes that they must save their data and release resources to prevent memory leaks. It's done
	 * via static methods with {@link commons.scripting.metadata.OnClassUnload} annotation
	 */
	 ...
	 * </pre>
	 *
	 * @see commons.scripting.classlistener.AggregatedClassListener
	 * @see commons.scripting.classlistener.ScheduledTaskClassListener
	 *
